    ...
    public partial class University : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProjectsToStudents", x => new { x.ProjectID, x.StudentID });
                    table.ForeignKey(
                        name: "FK_ProjectsToStudents_Projects_ProjectID",
                        column: x => x.ProjectID,
                        principalTable: "Projects",
                        principalColumn: "ProjectID",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProjectsToStudents_Students_StudentID",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProjectsToStudents_StudentID",
                table: "ProjectsToStudents",
                column: "StudentID");
